...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription: 'A unified monthly reporting view for application traffic, sessions, downloads, engagement, program content, and business-unit activity.',
    description: 'A broader operational reporting environment that combines workplace and digital experience measures into a consistent monthly analytical view.',
    ...
    outcome: 'Enabled reliable month-to-month reporting and gave stakeholders a single analytical view across engagement, usage, and business activity.',
    featured: true,
    visual: 'engagement',
  },
];
