...
export function Footer() {
  ...
  return (
    <footer className="footer shell">
      <div><Image className="footer-logo" src="/images/brand/nlc-logo.png" alt="NLC" width={2172} height={724} sizes="108px" /><strong>{profile.name}</strong><span>{profile.role}</span></div>
